...
{
  new (message_memory) lll_supervisor_msgs::msg::ObjectDetections(_init);
}

void ObjectDetections_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lll_supervisor_msgs::msg::ObjectDetections *>(message_memory);
  typed_message->~ObjectDetections();
}

size_t size_function__ObjectDetections__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<lll_supervisor_msgs::msg::ObjectDetection2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<lll_supervisor_msgs::msg::ObjectDetection2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<lll_supervisor_msgs::msg::ObjectDetection2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const lll_supervisor_msgs::msg::ObjectDetection2D *>(
    get_const_function__ObjectDetections__detections(untyped_member, index));
  auto & value = *reinterpret_cast<lll_supervisor_msgs::msg::ObjectDetection2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<lll_supervisor_msgs::msg::ObjectDetection2D *>(
    get_function__ObjectDetections__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const lll_supervisor_msgs::msg::ObjectDetection2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectDetections_message_member_array[2] = {
  {
    ...
    offsetof(lll_supervisor_msgs::msg::ObjectDetections, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<lll_supervisor_msgs::msg::ObjectDetection2D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(lll_supervisor_msgs::msg::ObjectDetections, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectDetections_message_members = {
  ...
  2,  // number of fields
  sizeof(lll_supervisor_msgs::msg::ObjectDetections),
...
get_message_type_support_handle<lll_supervisor_msgs::msg::ObjectDetections>()
{
  return &::lll_supervisor_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectDetections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lll_supervisor_msgs, msg, ObjectDetections)() {
  return &::lll_supervisor_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectDetections_message_type_support_handle;
}
