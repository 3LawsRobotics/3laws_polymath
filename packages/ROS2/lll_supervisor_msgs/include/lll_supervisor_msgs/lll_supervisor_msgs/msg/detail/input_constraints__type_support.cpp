...
void fetch_function__InputConstraints__lb(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__InputConstraints__lb(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__InputConstraints__lb(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__InputConstraints__lb(untyped_member, index));
...
void fetch_function__InputConstraints__m(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__InputConstraints__m(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__InputConstraints__m(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__InputConstraints__m(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
void fetch_function__InputConstraints__ub(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__InputConstraints__ub(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__InputConstraints__ub(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__InputConstraints__ub(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InputConstraints_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__InputConstraints__lb,  // fetch(index, &value) function pointer
    assign_function__InputConstraints__lb,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__InputConstraints__m,  // fetch(index, &value) function pointer
    assign_function__InputConstraints__m,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__InputConstraints__ub,  // fetch(index, &value) function pointer
    assign_function__InputConstraints__ub,  // assign(index, value) function pointer
