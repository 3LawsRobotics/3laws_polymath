...
void fetch_function__NodeHealthMetricMsgData__topics(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const lll_rdm_msgs::msg::NodeHealthMetricMsgTopicData *>(
    get_const_function__NodeHealthMetricMsgData__topics(untyped_member, index));
  auto & value = *reinterpret_cast<lll_rdm_msgs::msg::NodeHealthMetricMsgTopicData *>(untyped_value);
  value = item;
}

void assign_function__NodeHealthMetricMsgData__topics(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<lll_rdm_msgs::msg::NodeHealthMetricMsgTopicData *>(
    get_function__NodeHealthMetricMsgData__topics(untyped_member, index));
  const auto & value = *reinterpret_cast<const lll_rdm_msgs::msg::NodeHealthMetricMsgTopicData *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeHealthMetricMsgData_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__NodeHealthMetricMsgData__topics,  // fetch(index, &value) function pointer
    assign_function__NodeHealthMetricMsgData__topics,  // assign(index, value) function pointer
