...
inline void to_flow_style_yaml(
  const ClockHealthMetricUtcMsg & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const ClockHealthMetricUtcMsg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const lll_rdm_msgs::msg::ClockHealthMetricUtcMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lll_rdm_msgs::msg::ClockHealthMetricUtcMsg & msg)
{
