...
lll_rdm_msgs__msg__SensorValueRawMsg__init(lll_rdm_msgs__msg__SensorValueRawMsg * msg)
{
  ...
  if (!lll_rdm_msgs__msg__MsgHeader__init(&msg->header)) {
    lll_rdm_msgs__msg__SensorValueRawMsg__fini(msg);
    return false;
  }
  // data
  if (!lll_rdm_msgs__msg__VectorMsgData__init(&msg->data)) {
    lll_rdm_msgs__msg__SensorValueRawMsg__fini(msg);
    return false;
  }
  // tags
...
lll_rdm_msgs__msg__SensorValueRawMsg__fini(lll_rdm_msgs__msg__SensorValueRawMsg * msg)
{
  ...
  // data
  lll_rdm_msgs__msg__VectorMsgData__fini(&msg->data);
  // tags
...
lll_rdm_msgs__msg__SensorValueRawMsg__are_equal(const lll_rdm_msgs__msg__SensorValueRawMsg * lhs, const lll_rdm_msgs__msg__SensorValueRawMsg * rhs)
{
  ...
  // data
  if (!lll_rdm_msgs__msg__VectorMsgData__are_equal(
      &(lhs->data), &(rhs->data)))
  {
    return false;
  }
...
lll_rdm_msgs__msg__SensorValueRawMsg__create()
{
  ...
  lll_rdm_msgs__msg__SensorValueRawMsg * msg = (lll_rdm_msgs__msg__SensorValueRawMsg *)allocator.allocate(sizeof(lll_rdm_msgs__msg__SensorValueRawMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lll_rdm_msgs__msg__SensorValueRawMsg));
  bool success = lll_rdm_msgs__msg__SensorValueRawMsg__init(msg);
  if (!success) {
...
lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__init(lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lll_rdm_msgs__msg__SensorValueRawMsg * data = NULL;

  if (size) {
    data = (lll_rdm_msgs__msg__SensorValueRawMsg *)allocator.zero_allocate(size, sizeof(lll_rdm_msgs__msg__SensorValueRawMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lll_rdm_msgs__msg__SensorValueRawMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lll_rdm_msgs__msg__SensorValueRawMsg__fini(&data[i - 1]);
      }
...
lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__fini(lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lll_rdm_msgs__msg__SensorValueRawMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * array = (lll_rdm_msgs__msg__SensorValueRawMsg__Sequence *)allocator.allocate(sizeof(lll_rdm_msgs__msg__SensorValueRawMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__init(array, size);
  if (!success) {
...
lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__destroy(lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lll_rdm_msgs__msg__SensorValueRawMsg__Sequence__are_equal(const lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * lhs, const lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lll_rdm_msgs__msg__SensorValueRawMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lll_rdm_msgs__msg__SensorValueRawMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lll_rdm_msgs__msg__SensorValueRawMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lll_rdm_msgs__msg__SensorValueRawMsg * data =
      (lll_rdm_msgs__msg__SensorValueRawMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lll_rdm_msgs__msg__SensorValueRawMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lll_rdm_msgs__msg__SensorValueRawMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lll_rdm_msgs__msg__SensorValueRawMsg__copy(
