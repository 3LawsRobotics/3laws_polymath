...
inline void to_flow_style_yaml(
  const DynamicConsistencyMsg & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const DynamicConsistencyMsg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const lll_rdm_msgs::msg::DynamicConsistencyMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lll_rdm_msgs::msg::DynamicConsistencyMsg & msg)
{
