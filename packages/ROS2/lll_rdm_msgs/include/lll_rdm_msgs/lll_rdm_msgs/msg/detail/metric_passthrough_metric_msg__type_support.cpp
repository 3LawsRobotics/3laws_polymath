...
void fetch_function__MetricPassthroughMetricMsg__tags(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const lll_rdm_msgs::msg::MetricTagsMsgData *>(
    get_const_function__MetricPassthroughMetricMsg__tags(untyped_member, index));
  auto & value = *reinterpret_cast<lll_rdm_msgs::msg::MetricTagsMsgData *>(untyped_value);
  value = item;
}

void assign_function__MetricPassthroughMetricMsg__tags(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<lll_rdm_msgs::msg::MetricTagsMsgData *>(
    get_function__MetricPassthroughMetricMsg__tags(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MetricPassthroughMetricMsg_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__MetricPassthroughMetricMsg__tags,  // fetch(index, &value) function pointer
    assign_function__MetricPassthroughMetricMsg__tags,  // assign(index, value) function pointer
