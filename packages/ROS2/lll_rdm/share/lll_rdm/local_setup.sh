...
: ${AMENT_CURRENT_PREFIX:="/home/3laws/3laws-dev/.deploy/rdm/build/ROS2/install/lll_rdm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lll_rdm/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lll_rdm/environment/path.sh"
