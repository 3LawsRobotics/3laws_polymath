...
void fetch_function__Trajectory__times(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int64_t *>(
    get_const_function__Trajectory__times(untyped_member, index));
  auto & value = *reinterpret_cast<int64_t *>(untyped_value);
  value = item;
}

void assign_function__Trajectory__times(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int64_t *>(
    get_function__Trajectory__times(untyped_member, index));
...
void fetch_function__Trajectory__states(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__Trajectory__states(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__Trajectory__states(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__Trajectory__states(untyped_member, index));
...
void fetch_function__Trajectory__inputs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__Trajectory__inputs(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__Trajectory__inputs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__Trajectory__inputs(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectory_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__Trajectory__times,  // fetch(index, &value) function pointer
    assign_function__Trajectory__times,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Trajectory__states,  // fetch(index, &value) function pointer
    assign_function__Trajectory__states,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Trajectory__inputs,  // fetch(index, &value) function pointer
    assign_function__Trajectory__inputs,  // assign(index, value) function pointer
