...
class Metaclass_Float64VectorStamped(type):
    """Metaclass of message 'Float64VectorStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__float64_vector_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__float64_vector_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__float64_vector_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__float64_vector_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__float64_vector_stamped
...
class Float64VectorStamped(metaclass=Metaclass_Float64VectorStamped):
    """Message class 'Float64VectorStamped'."""
